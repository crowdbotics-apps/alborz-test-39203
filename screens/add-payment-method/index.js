...
const AddPaymentMethodScreen = params => {
  ...
  return <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <TextInput style={styles.kzVVDkVf}></TextInput></View>
        <View style={styles.inputs}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} onChangeText={text => setCardNumber(text)} value={cardNumber} placeholder="Enter your Card Number" placeholderTextColor="#9B9B9B" autoCapitalize="none" autoCorrect={false} passwordRules="" returnKeyLabel="text" />
          </View>
