"""
Django settings for alborz_test_39203 project.
...
ROOT_URLCONF = 'alborz_test_39203.urls'
...
WSGI_APPLICATION = 'alborz_test_39203.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "alborz_test_39203 API",
    "DESCRIPTION": "API documentation for alborz_test_39203 App",
    "VERSION": "v1",
}
